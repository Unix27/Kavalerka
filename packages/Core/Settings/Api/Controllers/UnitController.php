...
use Core\Settings\Api\Resources\UnitResource;

use Core\Settings\Models\Unit as Model;
use Core\Settings\Repositories\UnitRepository as Repository;
...
class UnitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return UnitResource::collection($dt->get($query));
    }
