				...
				<div class="authorization__inner">
					<div class="authorization__box">
						<div class="authorization__top" data-trigger=".authorization__trigger" data-content=".authorization__content">
							<button class="authorization__trigger @if(url()->current() == route('login')) active @endif" onclick="tabChange(this, 'form-authorization')">{!! __('site.enter') !!}</button>
							<button class="authorization__trigger @if(url()->current() == route('register')) active @endif" onclick="tabChange(this, 'form-registration')">{!! __('site.register') !!}</button>
						</div>
						<div class="authorization__body">

							<form action="#" class="authorization__content active" id="form-authorization">
...
{{--									<span></span>--}}
							...
							<form action="#" method="POST" class="authorization__content" id="form-registration">
								@csrf
