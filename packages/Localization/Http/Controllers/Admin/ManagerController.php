<?php namespace Localization\Http\Controllers\Admin;
...
class ManagerController extends BaseController
{
    ...
    public function index()
    {
        ...
        $groups = Translation::all()->groupBy('group');

        return view('admin::translations.index', compact('locales', 'groups', 'page_title', 'currentLocale'));
    }
    ...
    public function getIndex($group = null)
    {
        ...
        foreach($allTranslations as $translation){
         ...
         return view('admin::locales-manager.index')
            ...
            ->with('editUrl', $group ? route('admin.localization.manager.postedit', [$group]) : null)
    ...
    public function postImport(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Импортировано ' . $counter . ' переводов');
    }
    ...
    public function postFind()
    {
        ...
        return redirect()->back()->with('success', 'Найдено ' . $numFound . ' переводов');
    }
...
//        return redirect()->back()->with('success', 'Переводы успешно опубликованы');
    }
