 ...
 */
     ...
     */ 
         ...
         *
         * @return \Customers\Models\Customer|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \Customers\Models\Customer|false 
         * @static 
         */ 
     ...
     */ 
        ...
        {
                        /** @var \Localization\Helpers\Translator $instance */
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \Localization\Helpers\Translator::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \Localization\Helpers\Translator::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        return \Localization\Helpers\Translator::hasMacro($name);
        }
...
')
     ...
     */ 
        ...
        {
                        /** @var \Localization\Helpers\Localization $instance */
                        return $instance->setLocale($locale);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getCountryIcon($locale)
        {
                        /** @var \Localization\Helpers\Localization $instance */
                        return $instance->getCountryIcon($locale);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Localization\Helpers\Localization $instance */
                        return $instance->getCountryCode($locale);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getPublishedLocales()
        {
                        /** @var \Localization\Helpers\Localization $instance */
                        return $instance->getPublishedLocales();
        }
                    /**
         ...
         *
         * @return \Localization\Helpers\Repository Configuration repository
         * @static 
         */ 
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getPostImage($width, $height, $filename)
        {
                        /** @var \Blog\Helpers\Blog $instance */
                        return $instance->getPostImage($width, $height, $filename);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getImageUrl($width, $height, $path)
        {
                        /** @var \Blog\Helpers\Blog $instance */
                        return $instance->getImageUrl($width, $height, $path);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getInlineSvg($icon)
        {
                        /** @var \Site\Common\Helpers\Site $instance */
                        return $instance->getInlineSvg($icon);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function saveFromUrl($path, $url)
        {
                        /** @var \Admin\helpers\ImageTool $instance */
                        return $instance->saveFromUrl($path, $url);
        }
                    /**
         * 
         *
...
namespace  { 
            class Helper extends \Admin\helpers\Helper {}
            ...
            class Localization extends \Localization\Facades\Localization {}
            class Blog extends \Blog\Facades\Blog {}
            class Date extends \Jenssegers\Date\Date {}
            class Site extends \Site\Common\Facades\Site {}
            class ImageTool extends \Admin\Facades\ImageTool {}
